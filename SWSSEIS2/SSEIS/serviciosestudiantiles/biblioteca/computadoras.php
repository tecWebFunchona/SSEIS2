...
<div id="wrapper" class="clearfix">
    ...
    <div class="container titulos ">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="text-center azul">Préstamo de Computadoras</h2>
            </div>
            <div class="col-md-5">
                <p class="letra-homogenea-parrafo">La biblioteca cuenta con 8 computadoras para su uso de manera gratuita.</p>
                <p class="letra-homogenea-parrafo">Recomendaciones para hacer uso de las computadoras:</p>
                <ul class="list-unstyled left-padding">
                    <li>
                          <span class="descripcion">
                            <a class="social-icon si-colored si-rounded si-small si-email3">
                                <i class="icon-line2-screen-desktop"></i><i class="icon-line2-screen-desktop"></i>
                            </a>
                              El uso indebido de la credencial, materiales e instalaciones será sujeto de sanción.
                          </span>
                        <div style="clear:both"></div>
                    </li>
                    <li>
                        <span class="descripcion">
                            <a class="social-icon si-colored si-rounded si-small si-facebook ">
                                <i class="icon-food"></i><i class="icon-food"></i>
                            </a>
                            Se prohibe entrar con alimentos y bebidas.
                        </span>
                        <div style="clear:both"></div>
                    </li>
                </ul>
            ...
            <div class="col-md-7">
                <img src="./img/computadoras.jpg" class="img-responsive img-rounded" alt="Computadora en la biblioteca">
            </div>
        </div>
    </div>
    <br>
