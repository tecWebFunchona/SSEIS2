...
<head>
 ...
 -->
    ...
    <link rel="stylesheet" href="../../css/stackcard.css" type="text/css" />
    <link rel="stylesheet" href="../../css/eyaperesponsive.css" type="text/css" />
    ...
    <title>..::SSEIS::Extensión y Apoyos Educativos::Becas y otros Apoyos::..</title>
</head>
...
<div id="wrapper" class="clearfix">
    ...
    <!-- Contenido
        ============================================= -->
    <?php include('../contenido/becas.html'); ?>
