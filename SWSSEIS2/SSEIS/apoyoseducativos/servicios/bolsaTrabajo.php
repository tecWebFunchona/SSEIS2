...
<head>
    <!--
        ...
        Date: 30/07/17
        Time: 00:10
        Description: Esta es la página principal de la bolsa de trabajo.
     -->
    ...
    <title>..::SSEIS::Extensión y Apoyos Educativos::Bolsa de Trabajo::..</title>
</head>
<body class="stretched" data-loader="12" data-loader-color="#006699">
    ...
    <!-- Contenido
        ============================================= -->
    <?php include('../contenido/bolsatrabajo.html'); ?>
